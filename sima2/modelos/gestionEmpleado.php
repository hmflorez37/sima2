...
class gestionEmpleados{
    ...
    public function guardarEmpleado(Empleado $empleado){
        ...
        $sentencia=$this->pdo->prepare("INSERT INTO `empleado`(`id_empleado`, `nombre_empleado`, `apellido_empleado`, `telefono_empleado`, `direccion_empleado`, `cargo_empleado`) VALUES('$doc','$nombre_emp','$apellido_emp','$celular_emp','$direccion_emp','$cargo')");
        $sentencia->execute();
    ...
    public function editarEmpleado(Empleado $empleado){
        ...
        $sentencia=$this->pdo->prepare("UPDATE `empleado` SET `nombre_empleado`='$nombre_empleado',`apellido_empleado`='$apellido_empleado',`telefono_empleado`='$telefono_empleado',`direccion_empleado`='$direccion_empleado',`cargo_empleado`='$cargo_empleado' where `id_empleado`='$id_empleado'");
            $sentencia->execute();
    }
}
