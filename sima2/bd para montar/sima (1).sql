...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-07-2021 a las 21:16:49
...
(2, 'farola derecha', 'renault', '2024-02-12', 4),
(3, 'casco', 'shaft', '0000-00-00', 21),
(4, 'filtro', 'jax', '2021-06-29', 1),
(5, 'manguera', 'akt', '2021-06-10', 15),
(6, 'casco', 'jax', '2021-06-23', 10),
(7, 'manguera', 'tvs', '2021-06-24', 4),
(8, 'carenaje', 'honda cb125', '2025-06-28', 7),
(9, 'tornillo', 'universal', '2021-06-30', 100),
...
ALTER TABLE `manto`
  ...
  ADD CONSTRAINT `manto_ibfk_2` FOREIGN KEY (`id_item`) REFERENCES `productos_vendidos` (`id`);
