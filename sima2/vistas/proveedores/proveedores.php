...
<body>
    ...
    <div class="col-3" >
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="row g-3 needs-validation" method="POST" action="gestionProveedores.php"validate>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="nombre_prov"class="form-control" placeholder="marca" required> 
                                        <div class="valid-feedback">
                                        </div>
                                    </div>
        ...
        <input class="form-control me-2" type="text" placeholder="Search"name="buscarp" id="buscarp">
        </form>
        </div>
    </div>

    <div class="col-12 "id="listaProveedor">
